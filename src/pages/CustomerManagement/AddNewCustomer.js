          ...
          <div className="modal-body">
            <Formik
              ...
              validate={(values) => {
                ...
                if (!values.searchable_expire) {
                  errors.searchable_expire = locale.Searchable_is_required;
                }
                if (!values.start) {
              ...
              onSubmit={(values, { setSubmitting, resetForm }) => {
                ...
                dispatch(
                  AddCustomers(values, resetForm, elementRef.current, locale)
                );
                  ...
                  <div className="form-fields-wrap">
                      ...
                      <div className="col-md-6">
                        <div className="form-group mb-4">
                          ...
                          <Field
                            ...
                            value={
                              !values.short_name
                                ? values.name.replaceAll(" ", "_").toLowerCase()
                                : values.short_name
                                    .replaceAll(" ", "_")
                                    .toLowerCase()
                            }
                          ...
                          {checkShortname == 0 && checkShortname.length != 0 ? (
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="form-group mb-4">
                          <label>
                            {locale.Residance} <span className="error">*</span>
                          </label>
                          <Field
                            type="text"
                            name="residence"
