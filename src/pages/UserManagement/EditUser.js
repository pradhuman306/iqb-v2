...
function EditUser(props) {
  ...
  useEffect(() => {
    ...
    if (Object.keys(userData).length != 0) {
      setInputValue({
        ...
        enddate: end?.split(" ")[0],
        phone: phone,
        searchable: searchable_expire?.split(" ")[0],
        activate: activate,
      });
    }
  }, [userData]);
  ...
  const checkValidation = () => {
    ...
    if (!inputValues.searchable) {
      errors.searchable = locale.Searchable_is_required;
    } else {
      errors.searchable = false;
    }
    ...
    if (checkValidation()) {
      ...
      if (props.auth.role === "super_admin") {
        if (props.cid) {
          ...
          dispatch(
            editUser({ values: tmp, modal: elementRef.current, id: props.id, locale:locale, })
          );
        }
      } else {
        dispatch(
      ...
      if (validation.searchable != false) {
            ...
            <form action="" onSubmit={(e) => handleSubmit(e)}>
              <div className="form-fields-wrap">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="form-group mb-4">
                      <label>{locale.Searchable} <span className="error"> *</span></label>
                      ...
                      <div className="input-group date" id="datepicker1">
                        <input
                          ...
                          onBlur={() =>
                            setTouched({ ...touched, searchable: true })
                          }
                        />
                      </div>
                      <span className="error">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="form-group mb-4">
                      <label>{locale.Start_date} <span className="error"> *</span></label>
                ...
                <div className="row">
                  <div className="col-6">
                    <div className="form-group mb-4">
                      ...
                      <input type="checkbox" name="activate" checked={inputValues.activate}
