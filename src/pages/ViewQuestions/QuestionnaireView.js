...
const QuestionnaireView = (props) => {
  ...
  return (
    <>
      <div className="body-content user-body-content">
        {!pending ? (
          <div className="fml-main">
            <div className="fml-content">
              <div className="fml-heading">
                <h3 className="mb-2">
                  ...
                  formData.questinnaireType_description.split("</p>").length !=
                    0
                    ? formData.questinnaireType_description
                        .split("</p>")[0]
                        .replace(/(<([^>]+)>)/gi, "")
            ...
            <div className="fml-sidebar" id="sticky">
              <div className={answerListNew.length > 0 ? 'after-wrapper fix-wrapper':"fix-wrapper"}>
