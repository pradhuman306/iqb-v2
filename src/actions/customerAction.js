...
import { SET_CUSTOMER_STYLE } from "../constants/actionTypes";
...
export const UpdateStyle = (payload, locale) => (dispatch) => {
  ajaxCall
...
export const UpdatePDFStyle = (payload, locale) => (dispatch) => {
  ajaxCall
...
export const editCustomers = (payload, locale) => (dispatch) => {
  ajaxCall
